...
NOTE: Due to some issues with github server, we had to force push our code onto the repository which removed the commit history on our project. This explains why our project only contains 1 commit.
